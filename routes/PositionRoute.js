...
router.get('/api/v1/employee/position/get', verifyUser, adminOnly, verifyToken, getPosition);
router.get('/api/v1/employee/position/:id', verifyUser, adminOnly, verifyToken, getPositionByid);
